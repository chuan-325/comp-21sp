...
![422-tree](hw_04_01.assets/422tree.png)
...
$$
bexpr \rightarrow bexpr {\bf{\text{ or }}} bterm\ |\ bterm\qquad\qquad
\\bterm \rightarrow bterm {\bf{\text{ and }}} bfactor\ |\ bfactor\qquad
\\bfactor \rightarrow {\bf{\text{not }}} bfactor\ |\ (bexpr)\ |\ true\ |\ false
$$
...
$$
bexpr\rightarrow bterm X
\\X\rightarrow {\bf{\text{ or }}} bterm X\ |\ \epsilon
%\\bexpr \rightarrow bexpr {\bf{\text{ or }}} bterm\ |\ bterm\qquad\qquad
\\bterm\rightarrow bfactor Y
\\Y\rightarrow {\bf{\text{ and }}} bfactor\ |\ \epsilon
%\\bterm \rightarrow bterm {\bf{\text{ and }}} bfactor\ |\ bfactor
\\bfactor \rightarrow {\bf{\text{not }}} bfactor\ |\ (bexpr)\ |\ true\ |\ false
$$
