...
![pic-1.](hw_02_01.assets/pic-1.png)
...
![pic-2.](hw_02_01.assets/pic-2.png)
...
2. $num$ 为语法分析树的非叶结点:
   ...
   - 语法分析树根结点的两个子结点是 $num$ 和 $num$, 也就是 $num_0\rightarrow num_1\ num_2$ 的形式, 这种情形下, $num_0=num_1\times 2^{|num_2|}+num_2$, 因此只要 $num_1$ 和 $num_2$ 被 3 整除, $num_0$ 就能被 3 整除;

结合以上两点, 由数学归纳法可知, 该文法生成的所有二进制串都能被 3 整除.
...
![pic-3.](hw_02_01.assets/pic-3.png)

$9-5*2$:

![pic-4.](hw_02_01.assets/pic-4.png)
